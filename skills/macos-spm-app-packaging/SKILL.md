...
description: >-
  Scaffold, build, and package SwiftPM-based macOS apps without Xcode project. Use when: creating macOS app bundles from SPM, signing, notarizing, or building appcasts.
license: MIT
compatibility: "macOS with Swift Package Manager"
metadata:
  ...
  use-cases:
    ...
    - "Set up notarization and appcast for macOS distribution"
