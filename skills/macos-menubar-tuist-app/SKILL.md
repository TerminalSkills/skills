...
description: >-
  Build macOS menubar apps with Tuist and SwiftUI. Use when: creating LSUIElement menubar utilities, defining Tuist manifests, or building menubar apps without Xcode-first workflows.
license: MIT
compatibility: "macOS with Tuist and SwiftUI"
metadata:
