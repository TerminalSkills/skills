...
name: web-design
description: >-
  Comprehensive web design skill covering layout, typography, color systems, components,
  and responsive design. Use when: designing web interfaces, creating design systems,
  implementing UI components, advising on visual design decisions.
license: MIT
...
metadata:
  ...
  version: "1.0.0"
  category: design
  tags: [web-design, ui, ux, design-system, typography, layout, responsive, css]
  use-cases:
    - "Design a landing page with proper visual hierarchy and spacing"
    - "Create a consistent design system with colors, typography, and components"
    - "Review and improve the visual design of a web application"
