...
metadata:
  ...
  version: "1.0.0"
  category: design
  tags: [website-cloning, design-to-code, reverse-engineering, pixel-perfect, next-js, chrome-mcp]
  use-cases:
    - "Clone a competitor's landing page as a starting point for your own design"
    - "Rebuild a legacy website in Next.js with modern component architecture"
