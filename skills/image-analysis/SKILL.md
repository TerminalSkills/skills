...
metadata:
  ...
  version: "1.0.0"
  category: design
  tags: [image-analysis, vision-ai, color-palette, design, visual, claude]
  use-cases:
    - "Extract a color palette from a brand image or screenshot"
    - "Analyze the visual style and mood of reference designs"
    - "Identify dominant colors in product photos for theming"
