...
name: django
description: |
  Django is a batteries-included Python web framework that follows the model-template-view
...
{% for article in object_list %}
  <article>
    <h2><a href="{% url 'core:article-detail' article.slug %}">{{ article.title }}</a></h2>
