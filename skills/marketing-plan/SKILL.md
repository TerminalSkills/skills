...
name: marketing-plan
description: >-
  Create a comprehensive marketing plan — channels, messaging, content strategy, and growth
  tactics. Use when: planning marketing for a product launch, creating a content calendar,
...
metadata:
  ...
  version: "1.0.0"
  category: business
  tags: [marketing, strategy, content, growth, go-to-market, startup]
  use-cases:
    - "Create a 90-day marketing plan for a product launch"
    - "Design a content strategy that drives organic signups"
    - "Plan distribution channels for a B2B SaaS product"
