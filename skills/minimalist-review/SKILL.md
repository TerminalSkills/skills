...
description: >-
  Perform minimalist code reviews focused on what matters — correctness, simplicity, and
  shipping speed over perfection. Use when: reviewing PRs quickly, avoiding over-engineering
  in code review, maintaining high velocity with good quality.
license: MIT
...
metadata:
  ...
  tags: [code-review, minimalism, productivity, shipping, quality]
  use-cases:
    - "Review a PR focused on correctness and simplicity, not style"
    - "Speed up code review by focusing on what actually matters"
    - "Apply minimalist review principles to ship faster without sacrificing quality"
