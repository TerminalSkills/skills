...
license: MIT
compatibility: "Any project with coding agent history"
metadata:
  author: terminal-skills
  version: "1.0.0"
  category: development
  tags: [audit, skills, project-analysis, recommendations]
  use-cases:
    - "Audit current project skills for gaps"
    - "Get data-driven skill recommendations based on project history"
